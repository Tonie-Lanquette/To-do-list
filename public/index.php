...
<body class="relative">
    ...
    <!-- Creat Account Modal -->
    <!-- <div id="creatAccount" class="modal absolute top-0 w-screen h-screen z-20 bg-green-300 ">
        <div class="flex flex-col justify-center px-6  py-12 lg:px-8 w-1/2 mx-auto">
            <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Creat account</h2>
            </div>
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <div class="space-y-6">
                    ...
                    <div>
                        <label for="creatEmail" class="block text-sm font-medium leading-6 text-gray-900">Email address</label>
                        <div class="mt-2">
                    ...
                    <div>
                        <div class="flex items-center justify-between">
                            <label for="creatPassword" class="block text-sm font-medium leading-6 text-gray-900">Password</label>
                        </div>
                        <div class="mt-2">
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input id="confirmationPassword" name="confirmationPassword" type="password" autocomplete="current-password" required class="block w-full bg-orange-50 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-green-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-300 sm:text-sm sm:leading-6 indent-3 creatConfirmationPasswordInput">
                        </div>
                    </div>

                    <div>
                        <button type="submit" onclick="creatAccount()" class="mt-14 mb-10 flex w-full justify-center rounded-md bg-green-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600 ">Creat account</button>
                    </div>
                    <div>
                        <button type="submit" onclick="loginModal()" class=" flex w-full justify-center rounded-md bg-green-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600 ">Already member ? Just login</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Login modal -->
    <!-- <div class="modal absolute top-0 w-screen h-screen z-10 bg-green-300 ">
        <div class="flex flex-col justify-center px-6  py-12 lg:px-8 w-1/2 mx-auto">
            <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <div class="space-y-6">
                    ...
                    <div>
                        <button type="submit" onclick="loginAccount()" class="mt-14 mb-10 flex w-full justify-center rounded-md bg-green-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600 ">Login</button>
                    </div>
                    <div>
                        <button type="submit" onclick="creatModal()" class=" mb-10 flex w-full justify-center rounded-md bg-green-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600 ">Not a member ? Creat an account</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-lime-50 flex">
            ...
            <div class=" h-dvh w-1/5 flex-col flex items-center bg-green-300 justify-between fixed ">
                <div class="w-4/6 flex flex-col items-center">
                    ...
                    <div class="w-full h-10 bg-lime-50 rounded-full mt-6 text-center pt-2 uppercase text-black text-s font-semibold"><?php echo "Tonie" ?></div>
                    <div class="w-full h-10 bg-lime-50 rounded-full mt-6 text-center pt-2 uppercase text-black text-s font-semibold"><?php echo "Lanquette" ?></div>
                </div>
            ...
            <div class="flex flex-col items-center">
                ...
                <form class="flex flex-col w-3/5 bg-green-300 rounded-xl my-10  px-20 items-center" id="addTaskForm" action="" method="">
                    ...
                    <div class="relative w-full mb-3">
                        ...
                        <input type="text" name="categoryTask" id="categoryTask" class="border-0 px-3 py-3 rounded text-sm shadow w-full
                    bg-green-50" placeholder="Food" required />
                    </div>
                    <div class="relative w-full mb-3">
                        <label class="block uppercase text-black text-xs font-bold mb-2" for="descriptionTask">Message</label>
