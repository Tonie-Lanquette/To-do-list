                ...
                <form action="" method="POST">
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input id="creatEmail" name="creatEmail" type="email" autocomplete="email" required class="block w-full bg-orange-50 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-green-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-300 sm:text-sm sm:leading-6 indent-3 creatEmailInput uppercase text-black text-s font-semibold">
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="flex items-center justify-between">
                                <label for="confirmationPassword" class="block text-sm font-medium leading-6 text-gray-900 uppercase text-black text-s font-semibold">Confirmation Password</label>
                            </div>
                            <div class="mt-2">
