...
export default class ToDoList {
  ...
  construcor(listeTache, ordreTriDefaut) {
    this.listeTache = listeTache;
    this.ordreTriDefaut = ordreTriDefaut;
  }
  ...
  set(listeDesTaches) {
    this.#listeTaches = listeDesTaches;
  }
